...
namespace ManejoPresupuesto.Services
{
    ...
    public class ServicioReportes : IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladasPorCuenta(int usuarioId,int cuentaId,int mes,int año,dynamic ViewBag)
        {
            ...
            var modelo = await GenerarReporteTransaccionesDetalladas(fechaInicio, fechaFin, transacciones);
        ...
        private async Task<ReporteTransaccionesDetalladas> GenerarReporteTransaccionesDetalladas(DateTime fechaInicio, DateTime fechaFin, IEnumerable<Transaccion> transacciones )
        { 
